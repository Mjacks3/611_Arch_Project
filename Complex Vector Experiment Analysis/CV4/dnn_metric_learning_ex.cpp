...
int main() try
{
    ...
    samples.push_back({2,32,32,122,432,900,90,2933,102}); labels.push_back(10);
    samples.push_back({42,2,1,345,100,1000,129,323,11}); labels.push_back(10);

    samples.push_back({3,31,30,432,322,100,321,10,1}); labels.push_back(5);
    samples.push_back({19,8,9,10,213,132,250,12,1}); labels.push_back(5);
