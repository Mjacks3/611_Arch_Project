...
int main() try
{
    ...
    samples.push_back({2,32,32,44,102}); labels.push_back(10);
    samples.push_back({42,2,1,102,212}); labels.push_back(10);

    samples.push_back({3,31,30,123,40}); labels.push_back(5);
    samples.push_back({19,8,9,234,450}); labels.push_back(5);
