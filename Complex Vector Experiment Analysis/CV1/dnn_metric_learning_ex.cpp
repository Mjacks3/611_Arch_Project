...
int main() try
{
    ...
    samples.push_back({2,32,32}); labels.push_back(10);
    samples.push_back({42,2,1}); labels.push_back(10);

    samples.push_back({3,31,30}); labels.push_back(5);
    samples.push_back({19,8,9}); labels.push_back(5);
